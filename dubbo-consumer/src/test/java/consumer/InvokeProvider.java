...
import com.dubbo.provider.service.impl.AnnoationServiceInvoke;
...
//		}
	 ...
	 */
	@Test
	public void testAnnoationServiceInvok(){
		context=new ClassPathXmlApplicationContext("spring.xml");
		context.start();
		AnnoationServiceInvoke service=context.getBean(AnnoationServiceInvoke.class);
		service.testAnnoationService();
	}
}
